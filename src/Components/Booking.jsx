        ...
        <div className="bg-white w-full rounded-2xl text-black p-8">
          ...
          <div className="text-center mt-12 border-t border-gray-400 border-dashed ">
            <button
              ...
              className="w-full inline-block py-3 px-8 text-xl font-bold text-center mt-5 border bg-transparent text-red-500 rounded-full transition ease-in-out duration-300 hover:text-white hover:bg-red-500"
            >
              Cancel Appointment
            </button>
          </div>
