...
const NoBooking = () => {
    return (
        <div className="bg-white w-full rounded-2xl text-black py-16 px-5 text-center">
                    ...
                    <Link className='px-8 py-3 font-bold text-xl rounded-full bg-blue-500 text-white outline-0 border-0 hover:bg-blue-600 transition ease-in-out duration-300' to={'/'}>See Doctors</Link>
        </div>
    );
};
